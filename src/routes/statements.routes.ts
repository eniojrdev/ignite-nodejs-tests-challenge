import { TransferAmountController } from "@root/modules/statements/useCases/transferAmount/TransferAmountController";
...
const transferAmouhtController = new TransferAmountController();
...
statementRouter.post("/transfer/:id", transferAmouhtController.execute);
